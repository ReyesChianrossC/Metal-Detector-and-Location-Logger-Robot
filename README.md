...
## 🔒 Security Note
This repository uses `.gitignore` to prevent uploading compiled binaries, cache files, and IDE backups. Passwords and SSIDs have been safely removed from the code and replaced with placeholders to protect your network.
